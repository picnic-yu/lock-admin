<template>
    <div>
        <p :class="classNames" :style="{textAlign: 'center', color: color, fontSize: countSize, fontWeight: countWeight}"><span v-cloak :id="classNames">{{ startVal }}</span><span>{{ unit }}</span> 
