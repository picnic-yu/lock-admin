            ...
            createView() {
                ...
                const option = {
                    ...
                    legend: {
                        ...
                        data: ["总客户放款金额", "正常客户放款金额","观察户放款金额","法诉客户放款金额"]
                    },
                    // toolbox: {
                    //     show: true,
                    //     top: '10%',
                            ...
                            itemStyle: {
                                normal: {
                                    ...
                                    label: {
                                        ...
                                        position: "top",
                                        formatter: function (p) {
                                            return p.value? `${p.value}万元 (${Math.round(p.value/self.allCustomer[0]*10000)/100}%)`:''
                                        }
                                    }
                                }
                            },
                            ...
                            itemStyle: {
                                normal: {
                                    ...
                                    label: {
                                        ...
                                        position: "top",
                                        formatter: function (p) {
                                            return p.value? `${p.value}万 (${Math.round(p.value/self.allCustomer[0]*10000)/100}%)`:''
                                        }
                                    }
                                }
                            },
                            data: this.allObserver
                        },
                        {
                            name: "法诉客户放款金额",
                            type: "bar",
